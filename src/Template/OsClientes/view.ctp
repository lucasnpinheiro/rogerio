<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Os Cliente'), ['action' => 'edit', $osCliente->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Os Cliente'), ['action' => 'delete', $osCliente->id], ['confirm' => __('Are you sure you want to delete # {0}?', $osCliente->id)]) ?> </li>
